...
sales_and_plan as (
	select
		...
		avg(sales.sales_cnt) as avg_sales,
		max(sales.sales_cnt) as max_sales
	from sales
...
sales_and_plan_and_max_sales_day as (
	select
	*,
...
select 
    * 
from sales_and_plan_and_max_sales_day 
left join promo 
	on promo.product_id = sales_and_plan_and_max_sales_day.product_id 
	and promo.shop_name = sales_and_plan_and_max_sales_day.shop_name
	and promo.promo_date  = sales_and_plan_and_max_sales_day.date_max_sales
```  
